...
public interface memberDaoInterface {
	...
	public int MemberRegister(memberDto member);	//회원등록		
	public List<memberDto> MemberList();			//회원등록한 리스트
	public String Login(String id);					//로그인
	public memberDto userInformation(String id);	//로그인 인증된 사용자 정보 불러오기
	public int changeInfo(memberDto member);		//사용자의 자신의 비밀번호 or 주소 or 폰번호 or 이메일 변경
	...
	public int FindPwUpdate(memberDto dto);			// 비밀번호 찾기에서 사용자의 데이터가 DB에 있으면 자동적으로 pw 바꾸고 다시 email로 보내주기
