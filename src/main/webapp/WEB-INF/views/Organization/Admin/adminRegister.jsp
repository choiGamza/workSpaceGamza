      ...
      <ul class="sidebar navbar-nav"
         ...
         <c:if test="${user.id=='admin'}">
            ...
            <li class="nav-item"
               ...
               href="#collapse1" class="nav-link" data-toggle="collapse" style="background-color: #85ce36; color: #ffffff;"> <i
...
<!--  --------------------------------------------------------------------------------------------------------------------------- -->
    ...
    <div class="modal fade" id="myModal" role="dialog" >
      <div class="modal-dialog" >
         ...
         <form action = "addMember" class = "form-inline" method = "post">
            <div class="modal-body">
               
                    고유 ID <input type="text" class="form-control" placeholder="아이디" name = "id">
                   <br>   <br>
               <input type = "hidden" value = "1" name = "pw">
                ...
                <select name = "department" class = "form-control" style = "width:100px;">
                <c:forEach items = "${departmentList }" var = "departmentList">
                   <option value = "${departmentList.department }">${departmentList.department }
                 </c:forEach>
                </select>
                직급 
                <select name = "position" class = "form-control" style = "width:100px;">
                ...
                주민번호 <input type = "text" class = "form-control" name = "registernum" style = "width:380px;">
               <br><br>
	        폰번호 <input type = "text" class = "form-control" name = "phonenum" style = "width:380px;">
	        <br><br>
                주소 <input type = "text" name = "address" class = "form-control" style = "width:380px;"><br><br>
               email <input type = "email" name = "email" class = "form-control" style = "width:380px;">
   ...
   <div class = "container">
    <form method = "post" action = "RegisterPosition">
               <select name = "select" class = "form-control" style = "width:90px; float:left;">
               <!--  c if 넣어야됨 form 고른거에따라서 selected가 바뀌게 -->
                  <option selected = "selected">부서명</option>
                  <option value = "development">개발팀</option>
                  <option value = "data">전산팀</option>
                  <option value = "marketing">영업팀</option>
               </select>
            </form>
            <button type="button" class="btn btn-info btn-sm" id="myBtn" style = "float:right;">생성</button>
      <table class="table table-striped" style="text-align:center; border:2px; solid #dddddd">
         <tr>
            <th colspan = "5" style="background-color:#eeeeee; text-align: center;">회원관리</th>
         </tr>
         <tr>
            <td> 이름 </td>
            <td> 부서 </td>
         ...
         <tr>
            ...
            <td> ${memberList.department }</td>
            <td> ${memberList.position } </td>
            <td> 
            <a class="badge badge-pill badge-primary" href="userDetailInfo?id=${memberList.id }">상세정보</a>
