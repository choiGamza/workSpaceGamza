...
<!--  --------------------------------------------------------------------------------------------------------------------------- -->
      ...
      <table class="table table-striped" style="text-align:center; border:2px; solid #dddddd">
         <tr>
            <th colspan = "3" style="background-color:#eeeeee; text-align: center;">부서관리</th>
         </tr>
         <tr>
            <td>부서명</td>
            <td>인원</td>
         ...
         <tr>
            ...
            <td>
         	...
         	<td>
         	<a class="badge badge-pill badge-danger" href="deleteDepartment?department=${department.department}">부서삭제</a>
         	</td>
                </tr>
         </c:forEach>
      </table>
	      ...
	      <div class="modal-dialog" >
	         <div class="modal-content">
	            <div class="modal-header">
	               <h3 class="modal-title">부서등록</h3>
	            </div>
	            <form action = "addDepartment" class = "form-inline" method = "post">
	            <div class="modal-body">
	         		부서명 <input type = "text" name = "department" class = "form-control" style = "width:250px;"><br><br>
