...
.img-circle {
	...
	<div class="row">
        ...
        <div class="col-lg-4 col-sm-6 text-center mb-4">
          <img class="rounded-circle img-fluid d-block mx-auto" src="${pageContext.request.contextPath}/resources/profileimg/master2.jpg" style = "width:150px; height : 150px;">
          <h3>John Smith
            <small>사장님</small>
          </h3>
          <p>The Joen 설립자</p>
