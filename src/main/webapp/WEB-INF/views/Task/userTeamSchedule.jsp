...
<link href="resources/css-circular-prog-bar.css" rel="stylesheet">
		...
		<div id="content-wrapper"
			...
			<div class="container-fluid"
				...
				<div id="content-wrapper">
					...
					<ol class="breadcrumb">
						<li class="breadcrumb-item"><a href="#">팀프로젝트</a></li>
						<li class="breadcrumb-item active">진행상황</li>
					</ol>

					<!-- Icon Cards-->
					<c:if test="${projectmemberlist!=null}">
						<div class="row">
							<c:forEach items="${projectmemberlist }" var="projectmemberlist"
								varStatus="vs">
								<a href="userTeamScheduleDetale?number=${projectmemberlist.number}"
									style="display: inline;">

									<div class="col-xl-3 col-sm-6 mb-3">
										<div class="card text-white o-hidden h-100"
											style="background-color: #3a4651">
											<div class="card-body" style="padding-left: 0px; padding-right: 0px; text-align: center;">
											<c:if test="${projectmemberlist.important==1}">
									<span class="badge badge-pill badge-warning"
													style="display: inline;">중요</span>
											</c:if>
											<c:if test="${projectmemberlist.progress==100 }">
												<span class="badge badge-pill badge-success"
													style="display: inline;">완료된 프로젝트</span>
													</c:if>
												<div class="mr-5" style="color: white; display: inline;">${projectmemberlist.title }</div>
											</div>

											<a class="card-footer text-white clearfix small z-1"
												style="background-color: #d7dde4"> </span> <c:if
													test="${projectmemberlist.progress<50}">
													
													<div class="progress-circle p${projectmemberlist.progress}"
														style="float: center; margin-left: 100px;">
													<!-- <div class="progress-circle p${projectmemberlist.progress}"
														style="float: center; margin-left: 100px;">
														-->

														<span>${projectmemberlist.progress}%</span>
												...
												</c:if> <c:if test="${projectmemberlist.progress>=50}">
												
													<div
														class="progress-circle over50 p${projectmemberlist.progress}"
														style="float: center; margin-left: 100px;"">
													...
													<div class="progress-bar progress-bar-striped bg-info" 
														role="progressbar" style="width : ${projectmemberlist.progress}% ;" aria-valuenow="50" aria-valuemin="0"
											...
											<c:if test = "${user.position == '팀장' }">
												<a href="projectDelete?title=${projectmemberlist.title}&&number=${projectmemberlist.number}" style = "text-align:right;">&nbsp; <i class="fas fa-trash-alt" style="color: white; padding-right : 20px;"></i></a>
											</c:if>
										</div>
									</div>
								</a>
					...
					<div class="col-xl-3 col-sm-6 mb-3">
						<div class="card text-white o-hidden h-100"
							...
							<div class="card-body" style="text-align: center;">
								...
								<div class="mr-5" style="color: white;">새 프로젝트 생성</div>
							</div>
							
							
							<a class="card-footer text-white clearfix small z-1"
								style="background-color: #d7dde4" href="newTeam" data-toggle="modal" data-target="#testModal"
								role="button" id="myBtn">
				...
				<div class="modal fade" id="myModal" role="dialog">
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<form action="newProject" class="form-inline" method="post">
								<div class="modal-body">
									제목 : <input type="text" placeholder="제목을 입력하세요.." name="title"
										class="form-control" style="width: 380px;"> <br>
									<br> 구성원 :

									<c:forEach items="${memberList}" var="memberlist">
									  <c:if test = "${memberlist.id == user.id }">
										<input type="checkbox" name="id" checked = "checked" value="${memberlist.id}"
											style="display: inline;">${memberlist.name}
									  </c:if>
									  <c:if test = "${memberlist.id != user.id }">
									  	<input type="checkbox" name="id" value="${memberlist.id}"
											style="display: inline;">${memberlist.name}
									  </c:if>
									</c:forEach>
								</div>
