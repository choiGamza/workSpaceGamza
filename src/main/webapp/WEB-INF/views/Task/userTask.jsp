         ...
         <div class="container-fluid"
            ...
            <div class="col-lg-9">
               <div class="card tasks">
                  <div class="card-header bordered">
                     ...
                     <h3 class="title" style="display: inline">업무일지</h3>
                     <button type="button" class="btn btn-info btn-sm" id="myBtn" style = "float:right;">추가하기</button>
   
                  </div>
                  <div class="card-block">
                     <div class="tasks-block" style="padding-left: 10px;">
                        <ul class="nav navbar-nav">
                        <c:forEach items = "${taskList }" var = "taskList" varStatus = "vs">
                           <li> 
                             ▪<a href = "#" data-toggle = "modal" class="identifyingClass" data-target="#TaskModal${vs.index }" role="button" id="Btn2"> ${taskList.task }</a><span class = "taskRight">${taskList.rdate }</span>               
                           </li>
                           
                           <div class="modal fade" id="TaskModal${vs.index }" role="dialog">
				               <div class="modal-dialog">
				                  <div class="modal-content">
				                     <div class="modal-header">
				                        <h3 class="modal-title">업무내용</h3>
				                     </div>
				                     <form action="updateTask" class="form-inline" method="post">
				                        <div class="modal-body">
				
				         					<textarea class="form-control" cols="60" rows="2" name = "task">${taskList.task }</textarea> <br> <br>
											<input type = "hidden" name = "bid" value = "${taskList.bid }">
											<input type = "hidden" name = "id" value = "${user.id }">
				                        </div>
				                        <div class="modal-footer" style="width : 600px;">
				                         
				                           <input type="submit" class="btn btn-primary" name = "taskUpdate" value="수정">
            ...
            <div class="modal fade" id="myModal" role="dialog">
               <div class="modal-dialog">
                  <div class="modal-content">
                     <div class="modal-header">
                        <h3 class="modal-title">업무추가</h3>
                     </div>
                     <form action="TaskAdd" class="form-inline" method="post">
                        <div class="modal-body">

                     <textarea class="form-control" cols="60" rows="2" name = "task"
											placeholder="해야 할 일.."></textarea> <br> <br>
			<!-- 생성한 날짜 자동 추가 -->
					<input type = "hidden" name = "id" value = "${user.id }">
                        </div>
                        <div class="modal-footer" style="width : 600px;">
