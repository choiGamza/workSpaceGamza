...
<link
   href="${pageContext.request.contextPath}/resources/bootstrap/vendor/datatables/dataTables.bootstrap4.css"
   rel="stylesheet">
...
<!--  --------------------------------------------------------------------------------------------------------------------------- -->
         ...
         <div class = "row">
            <div class="col-xl-6 col-sm-6 mb-3">
               <div class="card-header">
                  <i class="fas fa-newspaper"></i> <b>공지사항</b> <a href = "Notice" class = "moreView">더 보기</a>
               </div>
               <div class="card-body">
               <table class = "table">
                 	<c:forEach items = "${noticeList }" var ="noticeList">
                 	<tr>
                 		<td><span class="badge badge-pill badge-primary">공지</span> <a href = "noticeView?bid=${noticeList.bid }">${noticeList.title }</a></td>
                 	</tr>
                 	</c:forEach>
                </table>
               </div>
            ...
            <div class="col-xl-6 col-sm-6 mb-3">
               <div class="card-header">
                  <i class="far fa-hand-point-up"></i> <b>게시판</b> <a href = "Notice" class = "moreView">더 보기</a>
               </div>
               <div class="card-body">
               <table class = "table">
					<c:forEach items = "${boardList }" var ="boardList">
                 	<tr>
                 		<td>▪ <a href = "noticeView?bid=${boardList.bid }">${boardList.title }</a></td>
                 	</tr>
                 	</c:forEach>     
                </table>
               </div>
            ...
            <div class="col-xl-6 col-sm-6 mb-3">
               <div class="card-header">
                  <i class="fab fa-youtube"></i> <b>매일뉴스</b>
               </div>
               <div class="card-body">
					<iframe width="100%" height="300px" src="https://www.youtube.com/embed/RBTFuGM6PAc" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>          
               </div>
            ...
            <div class = "col-xl-6 col-sm-6 mb-3">
            	<div class = "card-header">
            		<i class="fas fa-file-word"> 업무일지</i><a href = "userTask?id=${user.id }" class = "moreView">더 보기</a>
            	</div>
            	<div class = "card-body">
            		<c:forEach items = "${taskList }" var = "taskList" varStatus = "vs">
                           <li> 
                             ${taskList.task } <span class = "taskRight">${taskList.rdate }</span>               
                           </li>
                    </c:forEach>
            	</div>
	...
	<div class="modal fade" id="changeModal" role="dialog" >
      <div class="modal-dialog" >
        ...
        <c:if test = "${user.profileimg == 'true' }">
         ...
         <br><br>
                   ...
                   <br>   <br>
   		PW 변경 <input type = "password" name = "pw" placeholder = "비밀번호 변경" class = "form-control">
   		<input type = "hidden" name = "pw2" value = "${user.pw }">
   		<br><br>
                   이름 - ${user.name }
      ...
      <script src="${pageContext.request.contextPath}/resources/bootstrap/vendor/datatables/jquery.dataTables.js"></script>
      <script src="${pageContext.request.contextPath}/resources/bootstrap/vendor/datatables/dataTables.bootstrap4.js"></script>
