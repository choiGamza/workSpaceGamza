   ...
   <div id="wrapper">
      ...
      <ul class="sidebar navbar-nav"
         ...
         <li class="nav-item"
            onmouseover="this.style.backgroundColor='#333e48'"
            onmouseout="this.style.backgroundColor='#3a4651'"><a
            href="#holidayMenu" class="nav-link" data-toggle="collapse" style="background-color: #85ce36; color: #ffffff;"> <i
...
<!--  --------------------------------------------------------------------------------------------------------------------------- -->
	...
	<table class="table table-striped"
					...
					<tr>
						<th colspan="5"
							style="background-color: #eeeeee; text-align: center;">휴가 승인
							내역</th>
					</tr>
					<tr>
               ...
               <tr>
               	  <td>${holidayList.holidaytype}</td>
                  <td>${holidayList.startday }</td>
                  <td>${holidayList.endday }</td>
                  
                  
                  <c:if test="${holidayList.result=='대기'}">
                  	<td><span class="badge badge-pill badge-success">승인대기</span></td>
                  </c:if>
                  <c:if test="${holidayList.result=='거절'}">
                  	<td><span class="badge badge-pill badge-danger">승인거절</span></td>
                  </c:if>
                  <c:if test="${holidayList.result=='승인'}">
                  	<td><span class="badge badge-pill badge-primary">승인수락</span></td>
                  </c:if>
                  <td><a class="badge badge-pill badge-primary" href="deleteHoliday?id=${holidayList.id}&holidaytype=${holidayList.holidaytype}">내역삭제</a></td>
               </tr>
						...
						<div class="modal-content">
							<div class="modal-header">
								<h3 class="modal-title">
									${select } 신청서 <i class="fas fa-phone"></i>
								</h3>
							</div>
