...
<!--  --------------------------------------------------------------------------------------------------------------------------- -->
 ...
 <br><br>
		 	<form method="post" action="writeHoliday">
					<table class="table table-striped"
							...
							<tr>
								...
								<select name="holidaytype" class="form-control"
									style="width: 90px; float: right;">
										...
										<option value="vacation2">반차</option>
										<option value="vacation3">특별사유</option>
			 		...
			 		<tbody>
	            <tr>
								<td class="size"><input type="date" class="form-control"
									name="startday" min="2018-11-07"
									style="width: 180px; float: right;"></td>
									<td>---</td>
								<td><input type="date" class="form-control" name="endday"
									min="2018-11-07" style="width: 180px; float: left;">
								</td>
							</tr>
							...
							<tr>
								<td colspan="3"><textarea class="form-control"
										placeholder="휴가 내용" name="content" maxlength="2048"
