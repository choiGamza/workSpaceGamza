      ...
      <ul class="sidebar navbar-nav"
            ...
            <div class="collapse" id="collapse1">
               <ul class="nav navbar-nav">
                  ...
                  <li class="nav-item"
                     onmouseover="this.style.backgroundColor='#333e48'"
                     onmouseout="this.style.backgroundColor='#3a4651'"><a
                     class="nav-link" href="adminHoliday"
                     style="padding-left: 20px; background-color: #85ce36; color: #ffffff;">
         ...
         <li class="nav-item"
            ...
            href="#taskMenu" class="nav-link" data-toggle="collapse">
               <i class="far fa-fw fa-calendar-alt"></i> <span
                  ...
                  <thead>
                     <tr>
                        <th colspan="2"
                           ...
                           ${holidaydto.name} ${holidaydto.position} 휴가 신청서</th>
									<c:if test= "${holidaydto.holidaytype=='연차'}" >	
										<span class="badge badge-pill badge-danger" style="float:right;">${holidaydto.holidaytype}</span>
									</c:if>
									<c:if test= "${holidaydto.holidaytype=='반차'}" >	
										<span class="badge badge-pill badge-danger" style="float:right;">${holidaydto.holidaytype}</span>
									</c:if>
									<c:if test= "${holidaydto.holidaytype=='특별사유'}" >
										<span class="badge badge-pill badge-danger" style="float:right;">${holidaydto.holidaytype}</span>
									</c:if>
							</tr>
						</thead>
						<tbody>
							<tr>
								<td class="size">${holidaydto.startday} 부터
									${holidaydto.endday} 까지</td>
							</tr>
							<tr>
								<td colspan="2">${holidaydto.content}</td>
							</tr>

                  </tbody>
               </table>
				<form method="post" action="processHoliday">
					<input type="hidden" name="id" value=${holidaydto.id}>
					<input type="hidden" name="process" value="거절">
					<input type="hidden" name="holidaytype" value=${holidaydto.holidaytype }>
           		 ...
           		 <form method="post" action="processHoliday">
					<input type="hidden" name="id" value=${holidaydto.id}>
					<input type="hidden" name="process" value="승인">
					<input type="hidden" name="holidaytype" value=${holidaydto.holidaytype }>
