            ...
            <div class="collapse" id="collapse1">
               <ul class="nav navbar-nav">
                  ...
                  <li class="nav-item"
                     onmouseover="this.style.backgroundColor='#333e48'"
                     onmouseout="this.style.backgroundColor='#3a4651'"><a
                     class="nav-link" href="adminHoliday" style="padding-left: 20px; background-color: #85ce36; color: #ffffff;">
...
<!--  --------------------------------------------------------------------------------------------------------------------------- -->
   ...
   <table class="table table-striped"
               ...
               <tr>
                  <th colspan="5"
                     style="background-color: #eeeeee; text-align: center;">휴가 신청 조회</th>
               </tr>
               <tr>
                  <td>이름</td>
                  <td>부서</td>
               ...
               <tr>
                  <td>${holidayList.name }</td>
                  <td>${holidayList.position }</td>
                  <td>${holidayList.holidaytype}</td>
                  <td><a class="badge badge-pill badge-primary" href="adminHolidayDetail?id=${holidayList.id}&holidaytype=${holidayList.holidaytype}">상세보기</a></td>
               </tr>    
               </c:forEach>
            </table>
